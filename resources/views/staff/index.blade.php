...
<!-- Modal -->
<div class="modal fade" id="createStaffModal" tabindex="-1" role="dialog" aria-labelledby="createStaffModalTitle"
    aria-hidden="true">
                            ...
                            <div class="menu-title navbar">
                                ...
                                <div class="navbar d-flex justify-content-end">
                                    <button type="button" data-toggle="modal" class="btn btn-success"
                                        data-target="#addNewStaff">Create Staff</button>
                                </div>
                            </div>
                                            ...
                                            <form action="{{ url('addNewStaff') }}" method="POST"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="fullname" name="fullname"
                                                        placeholder="FullName:" class="form-control mb-2">
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="phone" name="phone"
                                                        placeholder="phone Address:" class="form-control mb-2">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="department">Department:</label>
                                                    <input type="text" id="department" name="department"
                                                        placeholder="Department:" class="form-control mb-2">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="date_of_join">Date of Join:</label>
                                                    <input type="date" id="date_of_join" name="date_of_join"
                                                        placeholder="Date of Join:" class="form-control mb-2">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="status">Status</label>
                                                    <select name="status" class="form-control" for="status">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('destroy.staff', $item->id) }}" method="POST"

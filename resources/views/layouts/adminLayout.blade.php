    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-5">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light"><b style="font-family: cursive"> Admin</b></span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-user-times"></i> <!-- Updated icon to represent leave -->
                                <p>
                                    Leaves
                                    <i class="right fas fa-angle-left"></i>
                                </p>
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-users"></i> <!-- Updated to a staff-related icon -->
                                <p>
                                    Manage Staffs
                                    <i class="right fas fa-angle-left"></i>
                                </p>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('addDesignation')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-calendar-alt"></i> <!-- Changed to a calendar icon -->
                                <p>
                                    Calendar
                                    <i class="right fas fa-angle-left"></i>
                                </p>

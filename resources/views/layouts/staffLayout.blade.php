...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('admincss/dist/img/its.png') }}" alt="AdminLTELogo" height="80"
                width="80">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-5">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light"><b style="font-family: cursive"> Attendances</b></span>
            </a>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                {{-- <i class="nav-icon fas fa-umbrella-beach"></i> <!-- Changed to a holiday icon -->
                                --}}
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-user-times"></i> <!-- Updated icon for Leaves -->
                                <p>
                                    Leaves
                                    <i class="right fas fa-angle-left"></i>
                                </p>
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-calendar-alt"></i> <!-- Updated to a calendar icon -->
                                <p>
                                    Calendar
                                    <i class="right fas fa-angle-left"></i>
                                </p>
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                ...
                                <!-- Updated to a holiday/vacation icon -->
                                <p>
                                    Holiday
                                    <i class="right fas fa-angle-left"></i>
                                </p>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2024 <a href="https://adminlte.io/">Staff</a>.</strong>
            All rights reserved.

...
use App\Jobs\LogCoordinatesJob;
use App\Models\AttendanceCoordinate;
use App\Models\GeoAttendance;
use Illuminate\Http\Request;

class AttendCoordController extends Controller
{
    // Check-in method
    ...
    //     // Start a timer for logging coordinates every 5 minutes
    //     // You may want to implement a job to handle this asynchronously
    ...
    //     $attendanceRecords = AttendanceCoordinate::with('attendance') // Assuming you have set up the relationship

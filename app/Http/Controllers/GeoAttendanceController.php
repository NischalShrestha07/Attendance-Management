...
class GeoAttendanceController extends Controller
{
    ...
    public function summary()
    {
        ...
        if (Auth::user()->roleName === 'Super Admin') {
            ...
            return view('admin.geoAttendace.adminGeo', compact('attendanceRecords', 'employees'));
        } elseif (Auth::user()->roleName === 'Staff') {
            return view('admin.geoAttendace.staffGeo', compact('attendanceRecords', 'employees'));
        }
    }
    ...
    public function showAttendanceCoordinates()
    {
        ...
        if (Auth::user()->roleName === 'Super Admin') {
            ...
            return view('admin.attenCoordinate.adminCoord', compact('attendanceRecords'));
        } elseif (Auth::user()->roleName === 'Staff') {
            return view('admin.attenCoordinate.staffCoord', compact('attendanceRecords'));
        }
    }
}
